...
public class PlatformGeneratorEnemyMode : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (transform.position.x < generationPoint.position.x)
        {
            ...
            if (Random.Range(0f, 100f) < randomEnemyThreshold)
            {
                ...
                float enemyXPosition = Random.Range(-platformWidths[platformSelector] / 2f + 1f, platformWidths[platformSelector] / 2f - 1f);
