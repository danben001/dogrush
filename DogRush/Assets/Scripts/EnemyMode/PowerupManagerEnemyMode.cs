...
public class PowerupManagerEnemyMode : MonoBehaviour
{
    ...
    private PlatformGeneratorEnemyMode thePlatformGenerator;
    ...
    void Start()
    {
        ...
        thePlatformGenerator = FindObjectOfType<PlatformGeneratorEnemyMode>();
    ...
    void Update()
    {
        ...
        if (powerupActive)
        {
            ...
            if (powerupLengthCounter <= 0)
            {
                ...
                thePlatformGenerator.randomEnemyThreshold = enemyRate;
    ...
    public void ActivatePowerup(bool points, bool safe, float time)
    {
        ...
        enemyRate = thePlatformGenerator.randomEnemyThreshold;
